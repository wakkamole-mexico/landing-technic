    ...
    <v-container ref="contentv" fluid>
        <v-row justify="space-around">
            <v-card
                    ...
                    class="pa-2"
                    :elevation="10"
                    :width="$vuetify.breakpoint.mdAndUp?'60%':'85%'"
            >
                <v-card-text style="background-color: white">
                    <v-row>
                        <v-col col="12" md="12">
                            <div class="font-blink text-center font-weight-bold texto-azul-claro ma-4" style="font-size: 2em; line-height: 1em;">Escucha este playlist mientras</div>
                            <div class="font-blink text-center font-weight-bold texto-azul-fuerte ma-6" style="font-size: 3em; line-height: 1em">DISFRUTAS DE TU SET</div>
                        </v-col>
                        <v-col cols="12" md="12">
                            <iframe src="https://open.spotify.com/embed/playlist/4ou6L9ejdALaEzhrS1Ry6A" width="100%" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                        </v-col>

                    </v-row>
                </v-card-text>
                <v-img max-width="80" style="position: absolute; right: -25px; bottom: -15px" src="/img/png-07.png"></v-img>
            </v-card>
        </v-row>
        <v-dialog
                v-model="dialog"
